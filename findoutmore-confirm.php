...
<body>
    ...
    <head>
        <link rel="stylesheet" id="standardStyles" type="text/css" href="style.css">
        ...
        <script type="text/javascript">
            ...
            function cssFile() {
                ...
                if (cssString.href.endsWith('style.css')) {
                    element3.innerHTML = 'Normal colours <i class="fa fa-adjust"></i>';
                    document.getElementById('standardStyles').href = 'highContrast.css';
                } else {
                    element3.innerHTML = 'High contrast <i class="fa fa-adjust"></i>';
                    document.getElementById('standardStyles').href = 'style.css';
                }
            }
